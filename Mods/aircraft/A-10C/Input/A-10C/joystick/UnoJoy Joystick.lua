...
{combos = {{key = "JOY_BTN1"}},down = iCommandPlaneFSLeftWingBoostPump, up = iCommandPlaneFSLeftWingBoostPump, value_down = 1, value_up = 0, name = _('Left wing tank boost pump'), category = _('Fuel system control panel')},
{combos = {{key = "JOY_BTN2"}},down = iCommandPlaneFSRightWingBoostPump, up = iCommandPlaneFSRightWingBoostPump, value_down = 1, value_up = 0, name = _('Right wing tank boost pump'), category = _('Fuel system control panel')},
{combos = {{key = "JOY_BTN3"}},down = iCommandPlaneFSLeftMainBoostPump, up = iCommandPlaneFSLeftMainBoostPump, value_down = 1, value_up = 0, name = _('Left main tank boost pump'), category = _('Fuel system control panel')},
{combos = {{key = "JOY_BTN4"}},down = iCommandPlaneFSRightMainBoostPump, up = iCommandPlaneFSRightMainBoostPump, value_down = 1, value_up = 0, name = _('Right main tank boost pump'), category = _('Fuel system control panel')},
...
{combos = {{key = "JOY_BTN13"}}, down = iCommandPlaneAHCPMasterArm, up = iCommandPlaneAHCPMasterArm, value_down = 1, value_up = 0,name = _('Master switch ARM'), category = _('Armament HUD Control Panel')},
...
{combos = {{key = "JOY_BTN9"}}, down = iCommandPlaneGearUp, value_down = 1, name = _('Landing Gear Up'), category = _('Landing gear panel')},
{down = iCommandPlaneGearDown, 		name = _('Landing Gear Down'), category = _('Landing gear panel')},
{combos = {{key = "JOY_BTN10"}}, down = iCommandPlaneGearDown, value_down = 1,	name = _('Landing Gear Down'), category = _('Landing gear panel')},
