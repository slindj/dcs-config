...
{	combos = {{key = 'JOY_BTN27'}}, down = cmds_commands.Dispenser_EXT, up = cmds_commands.Dispenser_EXT, cockpit_device_id = devices.CMDS,	value_down =  1.0, value_up = 0.0,	name = _('DISPENSER Switch - Up'),						category = {_('Instrument Panel'), _('Dispenser')}},
{	combos = {{key = 'JOY_BTN28'}}, down = cmds_commands.Dispenser_EXT, up = cmds_commands.Dispenser_EXT, cockpit_device_id = devices.CMDS,	value_down = -1.0, value_up = 0.0,	name = _('DISPENSER Switch - Down'),					category = {_('Instrument Panel'), _('Dispenser')}},
