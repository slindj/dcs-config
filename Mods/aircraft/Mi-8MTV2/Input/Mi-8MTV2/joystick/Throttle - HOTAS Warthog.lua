...
{combos = {{key = "JOY_BTN28"}, },	down = device_commands.Button_22, up = device_commands.Button_22, cockpit_device_id = devices.WEAPON_SYS, value_up= 0, value_down = -1, name = _('Mode UPK/PKT/RS Switch - RS'), category = {_('Left Overhead Panel'), _('Armament System')}},
{combos = {{key = "JOY_BTN27"}, },	down = device_commands.Button_22, up = device_commands.Button_22, cockpit_device_id = devices.WEAPON_SYS, value_up= 0, value_down = 1, name = _('Mode UPK/PKT/RS Switch - RS'), category = {_('Left Overhead Panel'), _('Armament System')}},
