...
{combos = {{key = 'JOY_BTN1'}},	down = device_commands.Button_12, up = device_commands.Button_12,	cockpit_device_id = devices.NAVLIGHT_SYSTEM, value_down = 1, value_up = 0,	name = _('Nav. Lights Switch'), category = {_('Right Side Panel'), _('External Lights')}},
{combos = {{key = 'JOY_BTN2'}},	down = device_commands.Button_13, up = device_commands.Button_13,	cockpit_device_id = devices.NAVLIGHT_SYSTEM, value_down = 1, value_up = 0,	name = _('Formation Lights Switch'), category = {_('Right Side Panel'), _('External Lights')}},

{combos = {{key = 'JOY_BTN3'}},	down = device_commands.Button_14, up = device_commands.Button_14,	cockpit_device_id = devices.NAVLIGHT_SYSTEM, value_down = 1, value_up = 0,	name = _('Tip Light Switch'), category = {_('Right Side Panel'), _('External Lights')}},
{combos = {{key = 'JOY_BTN4'}},	down = device_commands.Button_15, up = device_commands.Button_15,	cockpit_device_id = devices.NAVLIGHT_SYSTEM, value_down = 1, value_up = 0,	name = _('Strobe Light Switch'), category = {_('Right Side Panel'), _('External Lights')}},
-- Engines
...
{	combos = {{key = 'JOY_BTN13'}}, down = device_commands.Button_76, up = device_commands.Button_76, cockpit_device_id = devices.WEAPON_SYS, value_down = 1, value_up = 0, name = _('Mine Arms Main Switch'), category = {_('Overhead CB Panels'), _('Armament System')}},
...
{ combos = {{key = 'JOY_BTN9'}}, down = device_commands.Button_27,	cockpit_device_id = devices.WEAPON_SYS,	value_down = 1,		name = _('Weapon Safe/Armed Switch - ON'),		category = {_('Armament System')}},
...
{ combos = {{key = 'JOY_BTN10'}}, down = device_commands.Button_27,	cockpit_device_id = devices.WEAPON_SYS,	value_down = 0,		name = _('Weapon Safe/Armed Switch - OFF'),		category = {_('Armament System')}},
